...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'fourth_db' => [
            'driver' => 'mysql',
            'host' => env('FOURTH_DB_HOST', '127.0.0.1'),
            'port' => env('FOURTH_DB_PORT', '3306'),
            'database' => env('FOURTH_DB_DATABASE', 'forge'),
            'username' => env('FOURTH_DB_USERNAME', 'forge'),
            'password' => env('FOURTH_DB_PASSWORD', ''),
            // ...
        ],
        'pgsql' => [
            'driver' => 'pgsql',
